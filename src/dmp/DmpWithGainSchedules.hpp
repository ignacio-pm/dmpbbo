...
Dmp::analyticalSolutionExtendedDims(const Eigen::VectorXd& ts, Eigen::MatrixXd& xs, Eigen::MatrixXd& xds, Eigen::MatrixXd& fa_gains) const;
...
Dmp::predictExtendedDims(const Eigen::VectorXd& phases, Eigen::MatrixXd& output_gains)
*/
...
public:
   ...
   * \param[out] fa_gains The output of the function approximators for the gains.
   *
   ...
   */
  void analyticalSolution(const Eigen::VectorXd& ts, Eigen::MatrixXd& xs, Eigen::MatrixXd& xds, Eigen::MatrixXd& forcing_terms, Eigen::MatrixXd& fa_output, Eigen::MatrixXd& fa_gains) const;
